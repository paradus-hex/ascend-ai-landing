  ...
  return (
    ...
    <div id="about" className=" lg:pt-[5rem] font-inter lg:flex lg:justify-between lg:items-center lg:mx-[5rem]">
      ...
      whileInView={
        ...
        className=" lg:w-[38rem] lg:text-md pt-[2rem] text-center lg:text-start my-5 text-[#8F9BB7] lg:[--x-from:20rem] lg:[--x-to:0rem] lg:[--opacity-from:100%] lg:[--opacity-to:100%] md:[--opacity-from:0%] md:[--opacity-to:100%] [--opacity-from:0%] [--opacity-to:100%]"
      viewport={{ once: true, amount: 0.8 }}
      >
