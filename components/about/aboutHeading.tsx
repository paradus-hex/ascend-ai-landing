...
const AboutHeading = () => {
  return (
    <div className="flex font-inter justify-between items-center mt-32 mr-[15rem] ml-[15rem]">
      <h1 className="text-5xl font-nunito font-bold w-[44rem] bg-gradient-to-t from-stone-600 via-stone-400 to-stone-100 inline-block text-transparent bg-clip-text">
        Pushing Boundaries with Advanced AI Automation
      </h1>

      <p className="w-[25rem] text-[#8F9BB7]">
